...
describe('PersistenceGenerators', () => {
    ...
    test('toVolumeMountEntry = (volumeClaimName, mountPoint)', () => {
        expect(generators_1.PersistenceGenerator.toVolumeMountEntry(some_name, some_mount))
            .toEqual({
    ...
    test('toVolumeEntry = (volumeClaimName) => ', () => {
        expect(generators_1.PersistenceGenerator.toVolumeEntry(some_name))
            .toEqual({
            name: some_name,
    ...
    test('toExpandRequest = (newSize: number, capacityUnit) => ', () => {
        expect(generators_1.PersistenceGenerator.toExpandEntry(some_size, some_capacity))
            .toEqual({
            spec: {
                resources: {
                    requests: {
    ...
    test('createVolumeTemplate', () => {
        expect(generators_1.PersistenceGenerator.createVolumeTemplate(some_namespace, some_name, some_name2))
            .toEqual({
    ...
    test('createSnapshotTemplate', () => {
        expect(generators_1.PersistenceGenerator.createSnapshotTemplate(some_namespace, some_name, some_name2, some_name3))
            .toEqual({
...
//# sourceMappingURL=generators.unit.js.map