...
describe('parser helper tests', () => {
    describe('getPrimaryFile', () => {
        ...
        test('getPrimaryFile, path 1', () => {
            const a_base_path = 1;
            const result = parser_1.getPrimaryFile(a_base_path, true, options);
        ...
        test('getPrimaryFile, path 3', () => {
            const a_base_path = 3;
            const result = parser_1.getPrimaryFile(a_base_path, false, options);
    ...
    describe('resolveKeys', () => {
        test('no data', () => {
            const a_basePath = {};
            const some_data = '';
            parser_1.resolveKeys(a_basePath, some_data);
