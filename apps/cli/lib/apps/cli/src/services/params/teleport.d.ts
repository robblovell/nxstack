...
export declare type TeleportWorkloadKind = 'Namespace' | WorkloadKinds;
export interface TeleportParams extends ServiceParams, OrchestratorParams, NamespaceParams, EnvMonitorParams {
